...
`description` is a routing decision — it states *when* to reach for the skill, not what it is. It is also mirrored in `README.md`'s table and, loosely, in both manifests under `.claude-plugin/`. Changing one means changing those.
